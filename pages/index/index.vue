	...
	<view>
		...
		<view class="searchTopBox">
			<view class="searchBoxRadius">
				...
				<image :src="require('../../static/search_two.png')" class="grace-search-icon searchBoxIcon"></image>
				<input class="searchBoxIpt" type="search" v-model="ipt" @confirm="searchNow($event)" placeholder="点击搜索" name="search"
				 @click="nav" disabled="true"></input>
			</view>
		</view>
	...
	export default {
		...
		methods: {
			...
			async loadget() {
				...
				const message = UserInfo.subscribe.subscribeDesc
				...
				const res = await this.$myRequest({
					url: '/zbger/inviteTenders/findTenData?provinceCode=' + cityValue + '&announcementType=' + zType + '&day=' +
						this.zTime + '&keyword=' + message + '&pageNo=' + this.num,
				});
